...
@Component("commercialInvoiceStrategy")
@Slf4j
public class CommercialInvoiceStrategy implements PricingStrategy {

    private static final BigDecimal SPREAD = new BigDecimal("0.015"); // 1.5% a.m.

    @Override
    public BigDecimal calculatePresentValue(BigDecimal faceValue, BigDecimal baseRate, int months) {
        log.debug("Calculating present value for Commercial Invoice: faceValue={}, baseRate={}, months={}",
